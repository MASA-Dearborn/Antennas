...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="1100">
      <FieldResultFile filename="Port1_h1[1100].prt" meshname="Port1_h1_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
  ...
  <Units>
    ...
    <Quantity factor="1000000" name="Frequency" unit="MHz"/>
